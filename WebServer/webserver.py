#Web Server Project for CS138
#Code sampled from "Computer Networking: A Top-Down Approach"
#Final code written by Craig Hulsebus
...
def webServer():
	...
	while True:
		...
		print("Webserver Initialized. Now Ready to Serve")
		...
		try:
			...
			connectionSocket.send("""HTTP/1.0 200 OK 
				...
				<body>
					You Successfully found your file!
				</body>
				</html>
				""".encode());
